  ...
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <section className="relative overflow-hidden">
        {/* ✅ overlays should NOT block clicks */}
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-orange-600 via-orange-600 to-neutral-950" />
        <div className="pointer-events-none absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top,white,transparent_55%)]" />
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20 text-center">
          <div className="mx-auto max-w-3xl rounded-2xl border border-white/15 bg-neutral-950/60 backdrop-blur p-10 shadow-2xl">
            ...
            <p className="text-neutral-200/90 mb-10 max-w-2xl mx-auto">
              One platform to explore house & landscape plans, view 2D/3D designs,
              book professional services, and get home-loan guidance.
            </p>

            <div className="flex gap-3 justify-center flex-wrap">
              {/* NOTE: if these routes don't exist yet, change to /login to test */}
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div
            ...
            className="cursor-pointer rounded-2xl border border-white/10 bg-neutral-950/40 backdrop-blur p-6 hover:border-orange-500/60 hover:bg-neutral-950/55 hover:shadow-lg transition-all"
          >
          ...
          <div
            ...
            tabIndex={0}
            onClick={() => navigate("/loan-request")}
            onKeyDown={(e) => e.key === "Enter" && navigate("/loan-request")}
            className="cursor-pointer rounded-2xl border border-white/10 bg-neutral-950/40 backdrop-blur p-6 hover:border-orange-500/60 hover:bg-neutral-950/55 hover:shadow-lg transition-all"
          >
            <div className="w-14 h-14 rounded-xl border border-orange-500/40 bg-orange-600/15 flex items-center justify-center mx-auto mb-4">
          ...
          <div
            ...
            onKeyDown={(e) => e.key === "Enter" && navigate("/inspection")}
            className="cursor-pointer rounded-2xl border border-white/10 bg-neutral-950/40 backdrop-blur p-6 hover:border-orange-500/60 hover:bg-neutral-950/55 hover:shadow-lg transition-all"
          >
            <div className="w-14 h-14 rounded-xl border border-orange-500/40 bg-orange-600/15 flex items-center justify-center mx-auto mb-4">
